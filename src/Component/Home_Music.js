...
class Home extends Component {
  ...
  //gets all posts
  componentDidMount = () => {
    axios.get("/auth/getMusic").then(res => {
              ...
              <div className="home-posts">
                ...
                {this.state.showPopup &&<div id='post-hover'>
                  ...
                  <div id='home-popup-content'>
                    <div id='popup-pic'>
                      <Link to={`/indivpost/${e.music_id}`}><img src={e.media} alt={e.title}/></Link>
                    </div>
                ...
                <button id='send-btn' onClick={()=>{this.props.addComment(e.user_id, e.music_id, this.state.comment); alert('comment added!'); this.setState({comment: ''})
